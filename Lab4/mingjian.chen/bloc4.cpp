...
void renderAxis(int size)
{
	...
	float va[4] = {0.0, 0.8, 0.0, 1.0};
	float vd_[4] = {0.0, 0.6, 0.0, 0.2};
	float ve_[4] = {0.0, 0.0, 0.0, 0.0};

	if(! ilumine) glColor4f(0.0, 0.8, 0.0, 1.0);
	else
	{
	...
	float va1[4] = {0.8, 0.0, 0.0, 1.0};
	float vd1_[4] = {0.6, 0.0, 0.0, 0.2};
...
{ 
	...
	glPushMatrix();
		...
		glPushMatrix();
			glTranslated(2.5, min_y*scaleLegoman_y_, 2.5);
			renderAxis(2);
		glPopMatrix();
