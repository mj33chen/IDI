...
//\  Last modified 2003-08-18. Contributors are listed on the homepage.
...
////////
if (typeof olInfo == 'undefined' || olInfo.simpleversion < 400) alert('overLIB 4.00 or later is required for the W3C Class Plugin.');
...
registerHook("createPopup",addOvDivCSS,FAFTER);
if (olInfo.simpleversion >= 410) registerNoParameterCommands('usedivcls,usestd');
//end 
